    ...
    <Col xs="4">
        ...
        <form id="form-battery" class="mt-4">
            <div class="form-group row">
                ...
                <div class="col-sm-{col_right}">
                    <input type="number" name="history" value="{config.battery.min}" class="form-control form-control-sm">
                    <small class="form-text text-muted">
                        <em>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-{col_right}">
                    <input type="number" name="history" value="{config.battery.max}" class="form-control form-control-sm">
                    <small class="form-text text-muted">
                        <em>
